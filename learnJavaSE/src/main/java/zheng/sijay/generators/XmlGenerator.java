package zheng.sijay.generators;
    ...
    public static void g1() {
        ...
        try {
            ...
            for (int i = 0; i < colmunList.size(); i++) {
                ...
                LinkedHashMap<String, Object> colmun = colmunList.get(i);
                field.setAttribute("fieldName", colmun.get("COLUMN_NAME")
                                                      .toString());
                field.setAttribute("fieldType", colmun.get("COLUMN_TYPE")
                                                      .toString());
                field.setAttribute("fieldSeq", String.valueOf(i + 1));
                field.setAttribute("Comments", colmun.get("COLUMN_COMMENT")
                                                     .toString());
